...
public class regExActivity {
    ...
    public static void username()throws IOException, FileNotFoundException{
        ...
        */
        File file = new File("C:\\Users\\Admin\\Desktop\\Coding\\Second Sem\\Experiments\\username.txt");
    ...
    public static void email()throws IOException, FileNotFoundException{
        ...
        */
        File file = new File("C:\\Users\\Admin\\Desktop\\Coding\\Second Sem\\Experiments\\email.txt");
        BufferedReader br = new BufferedReader (new FileReader(file));
    ...
    public static void findPanda()throws IOException, FileNotFoundException{
        ...
        */
        File file = new File("C:\\Users\\Admin\\Desktop\\Coding\\Second Sem\\Experiments\\panda.txt");
        BufferedReader br = new BufferedReader (new FileReader(file));
